...
export const RESUME_DATA: ResumeData = {
    ...
    "phone": "13865379680",
    "wechat": "nglichulong",
    "summary": "拥有设计院和新能源行业双重工作经验的结构工程师。在GAD杰地设计集团期间参与多个公建、商业和住宅项目的结构设计，积累了扎实的建筑结构设计基础和参数化建模能力；现于天合光能跟踪支架工程技术中心工作，成功支持50+全球项目，实施20个项目（总容量600MW），独立开发智能支架分析系统（T-STARS）并获得公司专利。两份工作体现了从建筑结构设计到新能源支架专业领域的技术深化，以及从单一项目执行到全球项目管理和工具创新的职业发展。",
    "tags": [
    ...
    "experience": [
        {
            "company": "天合光能股份有限公司",
            "position": "欧洲，南美，北美项目工程负责人/结构工程师",
            "year": "2023 六月~至今",
            ...
            "projects": [
                ...
                },
                {
                    ...
                    "description": "为欧洲团队开发数据迁移程序，解决大批量数据迁移难题，保障B级项目顺利推进，确保AI训练数据顺利迁移，该工具已进入试用阶段。"
                },
                {
                    "name": "西班牙团队技术支持与交流",
    ...
    "skills": {
        "专业技能": [
            "支架结构设计与优化：熟练掌握支架产品（1P单驱/双驱/G2、2P推杆/回转）的设计与计算",
            "多规范应用：熟练掌握并应用美标、欧标等多种国际规范进行结构设计与校核",
            "有限元分析：精通YJK, Midas, 3D3S，SAP2000等结构分析软件",
            "参数化设计：熟练使用Rhino+Grasshopper进行参数化建模与优化设计",
            "软件工具开发：具备独立开发工程计算软件的能力，熟悉软件架构设计与实现"
        ],
        "编程与开发": [
            "编程语言：精通Python，能够进行算法设计和数据处理",
            "开发工具：熟练使用VScode、PyCharm、Git等开发工具和代码版本控制",
